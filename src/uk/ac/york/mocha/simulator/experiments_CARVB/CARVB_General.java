...
public class CARVB_General {
	...
	public static OneSystemResults testOneCaseThreeMethod(Pair<List<DirectedAcyclicGraph>, CacheHierarchy> sys,
		...
		SimualtorNWC sim2 = new SimualtorNWC(SimuType.CLOCK_LEVEL, Hardware.PROC_CACHE, Allocation.CACHE_AWARE_NEW, // PROC_CACHE
				RecencyType.TIME_DEFAULT, sys.getFirst(), sys.getSecond(), cores, tableSeed, lcif);
		...
		SimualtorNWC cacheCASim3 = new SimualtorNWC(SimuType.CLOCK_LEVEL, Hardware.PROC_CACHE, Allocation.CARVB, // PROC_CACHE
		...
		SimualtorGYY cacheCASim4 = new SimualtorGYY(SimuType.CLOCK_LEVEL, Hardware.PROC_CACHE, Allocation.CARVB, // PROC_CACHE
